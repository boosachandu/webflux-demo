...
@Configuration
public class TweetControllerWithFunctional {
 ...
 /*   @Bean
  public RouterFunction<ServerResponse> routes(){
     return RouterFunctions.route(RequestPredicates.GET("/tweets/functional"), this::getAllTweets);
  }*/
    ...
    public RouterFunction<ServerResponse> routes() {
        return RouterFunctions.route()
                .GET("/tweets/functional", accept(MediaType.APPLICATION_JSON), this::getAllTweets)
                .build();
    }

    // @GetMapping("/tweets")
    public Mono<ServerResponse> getAllTweets(ServerRequest req) {
        Flux<Tweet> tweets = tweetRepository.findAll();
        return ok().contentType(MediaType.APPLICATION_JSON).body(tweets, Tweet.class).switchIfEmpty(ServerResponse.badRequest().build());
    }
    ...
    public Mono<ResponseEntity<Tweet>> getTweetById(ServerRequest request) {
        request.bodyToMono(Tweet.class)
                .flatMap(tweet -> tweetRepository.save(tweet));
    }*/
